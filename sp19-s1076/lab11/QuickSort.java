...
public class QuickSort {
    ...
    public static <Item extends Comparable> Queue<Item> quickSort(
        ...
        Item hold = getRandomItem(items);
        Queue<Item> lesser = new Queue<>();
        Queue<Item> pivot = new Queue<>();
        Queue<Item> greater = new Queue<>();
        partition(items, hold, lesser, pivot, greater);
        return catenate(catenate(quickSort(lesser),pivot), quickSort(greater));
    }
}
